...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func setUpAppearance() {
        if (scheme() != nil) {
            if scheme() == space {
                self.setNavBarAppearance(Colors().navBackgroundColor, textColor: UIColor.white, fontName: cFont)
            } else if scheme() == nature {
                self.setNavBarAppearance(Colors().brownColor, textColor: UIColor.white, fontName: cFont)
            }
        }
        else {
        self.setNavBarAppearance(Colors().navBackgroundColor, textColor: UIColor.white, fontName: cFont)
